...
PRESETS_HW_ACCEL_SCALE = {
    ...
    "preset-intel-qsv-h264": "-r {0} -vf vpp_qsv=extra_hw_frames=10:framerate={0}:w={1}:h={2}:format=nv12,hwdownload,format=nv12,format=yuv420p",
    "preset-intel-qsv-h265": "-r {0} -vf vpp_qsv=extra_hw_frames=10:framerate={0}:w={1}:h={2}:format=nv12,hwdownload,format=nv12,format=yuv420p",
